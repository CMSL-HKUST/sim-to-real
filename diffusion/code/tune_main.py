...
# path on the cloud
# image_folder = '/bohr/rf2-1r14/v4/train_exp/train/images'
# label_folder = '/bohr/rf2-1r14/v4/train_exp/train/labels'
image_folder = '/bohr/cross-kcdv/v1/train_exp_2test/train/images'
label_folder = '/bohr/cross-kcdv/v1/train_exp_2test/train/labels'
...
file_dir = '/bohr/cross-kcdv/v1'
file_name = 'c_simu.pth'
...
optimizer = torch.optim.AdamW(filter(lambda p: p.requires_grad, model.parameters()), lr=LEARNING_RATE) # weight_decay=None
